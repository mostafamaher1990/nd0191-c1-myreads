...
This project is part of Udacity React Developer Nanodegree and it is a book tracking app that allow users to manage their reads 
...
[`BooksAPI.js`](src/BooksAPI.js) contains the methods necessary to perform necessary operations on the backend:
